 ...
 */
public class CheckPhoneNoAfterReLoginTestCase {
    @DataProvider
    public Object[][] testCheckPhoneNoAfterReLoginDataProvider() {
        return TestUtil.getdata("testCheckPhoneNoAfterReLogin",
                Excel.getInstance());
    }

    @Test(dataProvider = "testCheckPhoneNoAfterReLoginDataProvider")
    public void testCheckPhoneNoAfterReLogin(Hashtable<String, String> data)
            throws InterruptedException, MalformedURLException {

        if (!TestUtil.isTestCaseExecutable("testCheckPhoneNoAfterReLogin",
                Excel.getInstance())) {
            DriverConfiguration.APPLICATION_LOGS
                    .debug("Skipping the test case :" + " testCheckPhoneNoAfterReLogin "
        ...
        try {
            ...
            Keywords.getKeywordInstance().clickOnLinkbyXpath(DriverConfiguration.getDriverInstance().driver1, Locator.getLocatorInstance().phoneNumberPlus);
            ...
            Assert.assertNotEquals(expectedPhoneNo, actualPhoneNo, "Phone no's are same");
            ...
            System.out.println("!!!!! TC Failed - testCheckPhoneNoAfterReLogin !!!!!");

        }
        System.out.println("Executed TC - testCheckPhoneNoAfterReLogin.");
        DriverConfiguration.APPLICATION_LOGS.debug("$$$$"
