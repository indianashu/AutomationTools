 ...
 */
public class FormFillByVisitorTestCase {
    @DataProvider
    public Object[][] testFormFillByVisitorDataProvider() {
        return TestUtil.getdata("testFormFillByVisitor",
                Excel.getInstance());
    }

    @Test(dataProvider = "testFormFillByVisitorDataProvider")
    public void testFormFillByVisitor(Hashtable<String, String> data)
            throws InterruptedException, MalformedURLException {

        if (!TestUtil.isTestCaseExecutable("testFormFillByVisitor",
                Excel.getInstance())) {
            DriverConfiguration.APPLICATION_LOGS
                    .debug("Skipping the test case :" + " testFormFillByVisitor "
        ...
        try {
            ...
            System.out.println("!!!!! TC Failed - testFormFillByVisitor !!!!!");

        }
        System.out.println("Executed TC - testFormFillByVisitor.");
        DriverConfiguration.APPLICATION_LOGS.debug("$$$$"
