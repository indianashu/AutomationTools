 ...
 */
public class EnterLongTextMessageByVisitorTestCase {

    @Test(dataProvider = "testEnterLongTextMessageByVisitorDataProvider")
    public void testEnterLongTextMessageByVisitor(Hashtable<String, String> data)
            throws InterruptedException, MalformedURLException {

        if (!TestUtil.isTestCaseExecutable("testEnterLongTextMessageByVisitor",
                Excel.getInstance())) {
            DriverConfiguration.APPLICATION_LOGS
                    .debug("Skipping the test case :" + " testEnterLongTextMessageByVisitor "
        ...
        DriverConfiguration.APPLICATION_LOGS.debug("$$$$"
                ...
                + "testEnterLongTextMessageByVisitor" + "$$$$");
        ...
        try {
            ...
            Thread.sleep(2000);
            Keywords.getKeywordInstance().enterDataInTextFieldByXpath(DriverConfiguration.getDriverInstance().driver1, Locator.getLocatorInstance().visitorTypeText, data.get(Locator.getLocatorInstance().ChatMsg));
            Thread.sleep(5000);
            Keywords.getKeywordInstance().clickOnButtonByXpath(DriverConfiguration.getDriverInstance().driver1, Locator.getLocatorInstance().visitorSendText);
            Thread.sleep(5000);
            String visitorText = Keywords.getKeywordInstance().GetLastVisitorTextVC(DriverConfiguration.getDriverInstance().driver1);
            ...
            System.out.println("!!!!! TC Failed - testEnterLongTextMessageByVisitor !!!!!");

        }
        System.out.println("Executed TC - testEnterLongTextMessageByVisitor.");
        DriverConfiguration.APPLICATION_LOGS.debug("$$$$"
    ...
    @DataProvider
    public Object[][] testEnterLongTextMessageByVisitorDataProvider() {
        return TestUtil.getdata("testEnterLongTextMessageByVisitor",
                Excel.getInstance());
    }
}
